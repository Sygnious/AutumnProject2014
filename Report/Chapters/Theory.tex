...
How a DMA engine should be implemented depends on the system environment. \cite{computer-construction}
...
\todo{Meh...}A DMA module on the other hand is specifically designed for data transfers. 
...
The \todo{Um... how does one define "appropriate"? Consider removal of that word} appropriate number of channels depends on the system.
