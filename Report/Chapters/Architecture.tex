...
This chapter gives an overview of the architectural design that was chosen for the project.
The Hasing Accelerator is first explained, followed by the DMA Module.
The DMA Module 
...
%\todo{Wait, is this really architecture?!?}
...
%>>>>>>> 409d81a765cc7b2dc87ca91feeb7e743e3b0a6f9
...
the module to the bus system. \todo{Den setningen skjønte jeg ikke}This makes it possible to use the DMA module without
