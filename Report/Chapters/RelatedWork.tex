...
\todo{Source to PIC24F chapter 1: introduction, page 2}The company Microchip Inc is a provider of microcontrollers and analog semiconductors.
Among their products is the PIC24F device family. 
The PIC24F manual, \todo{Add reference} chapter 54, describes the DMA module of the PIC24F family.
...
\todo{Add the Epiphany paper as source, point to chapters 1 (intro) and chapter 8 (DMA)}
...
\todo{Add source in image text}

\subsection{Cell Processor}
Kistler, Perrone and Petrini takes a look at the Cell Multiprocessor, developed by IBM, Sony and Toshiba, in their paper \todo{Add source here} \"Cell Communication Network: Built for Speed\".
