...
provides a speed-up of 19 times over a software implementation.

In addition, a DMA module is developed in order to do low-overhead memory
transfers in the SHMAC architecture in order to increase the energy performance
of the system by allowing CPUs to do other work or enter sleep states.
