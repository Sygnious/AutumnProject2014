...
\section{Topview}
Figure \ref{TopViewFinalSimple2IO} shows the entire DMA Module, with its components, inputs and outputs.
...
\section{DMA Controller State Machine}
...
The state machine can be seen in figure \ref{}.
